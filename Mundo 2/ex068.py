...
while True:
    ...
    # opcao = ' ' -> na situaçao se for colocar o comando While, conforme 
    #resolução do Guanabara
    opcao = str(input('Par ou ÍMPAR? [P/I] ')).upper().strip()[0] # Se colocar
    #um while not in 'PI': -> se qualquer outro caractere digitado voltará a perguntar
    print('-'*30)
    if soma % 2 == 0:
